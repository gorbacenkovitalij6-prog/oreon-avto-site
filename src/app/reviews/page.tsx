...
export default function ReviewsPage() {
  ...
  const textReviews = [
    ...
    },
    {
      ...
      text: "Купил BMW X5 через вас. Очень доволен качеством подбора и скоростью доставки. Цена действительно выгоднее, чем у дилеров.",
    ...
    },
    {
      ...
      text: "Купил Mercedes-Benz E-Class. Качество подбора на высоте, все документы в порядке. Очень доволен сотрудничеством!",
        ...
        <div className="max-w-screen-2xl mx-auto px-8 py-6">
          ...
          <div className="pt-6 grid grid-cols-1 md:grid-cols-4 gap-6 text-sm">
            ...
            <div>
              ...
              <a href="mailto:oreon.ooo@internet.ru" className="text-xs hover:text-blue-400 transition-colors">
